...
const HIGH_IMPACT = [
  ...
  'CEO 방한', '방한 체결', 'AI 협약 체결', 'AI 파트너십 체결', '방문 협력 체결', '상한가',
  // 소셜/소비자 운동 트리거 — 사주기 운동·애국기업·불매운동 수혜주 초기 감지용
  '애국기업', '불매운동', '불매', '사주기 운동', '소비자 운동', '소비자운동',
]
...
const SECTOR_KEYWORDS: Record<string, string[]> = {
  ...
  '자동차': ['자동차', '현대차', '기아', '완성차', '자율주행', '일론머스크', 'Elon Musk', '테슬라'],
  '철강':   ['철강', '포스코', '현대제철', '냉연강판'],
