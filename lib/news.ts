...
const SECTOR_KEYWORDS: Record<string, string[]> = {
  ...
  '전선':   ['전선', '케이블', '초고압', '전력망', '가온전선', '대한전선', 'LS전선', '전력 인프라', '전력케이블'],
  '전력기기': ['변압기', '전력기기', '배전', '송전', 'HD현대일렉트릭', '효성중공업', '전력 설비'],
  '레이저': ['레이저', '광학', '광섬유', '레이저 의료', '레이저 가공', '필옵틱스', '한빛레이저'],
  '수소':   ['수소', '연료전지', '수소차', 'FCEV', '두산퓨얼셀', '수소 경제', '그린수소'],
}
